      ...
      <div className='relative overflow-hidden'>
        <LandingPageLayout>
          <main>
            ...
            {/* Testimonial section */}
            <div className='pb-16 bg-gradient-to-r from-teal-500 to-cyan-600 lg:relative lg:z-10 lg:pb-0'>
              <div className='lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-8 lg:px-8'>
                ...
                <div className='mt-12 lg:col-span-2 lg:m-0 lg:pl-8'>
                  <div className='max-w-md px-6 mx-auto sm:max-w-2xl lg:max-w-none lg:px-0 lg:py-20'>
                    <blockquote>
                      <div>
                        <svg
            ...
            <div className='relative bg-gray-900'>
              ...
              <div className='relative max-w-md px-6 py-12 mx-auto sm:max-w-7xl sm:py-20 md:py-28 lg:px-8 lg:py-32'>
